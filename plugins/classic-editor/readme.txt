...
== Reception, traduction des informations des podcasts ==

function.php; getPodcastRssInfos(); getRssJson()
Récupération des infos et traduction du xml en json

post-podcasts.php; getPodcastRssInfos()
Appelle la fonction et récupère les infos du function.php

post-podcasts.php; <script></script>
Passe les variables php (infos récupérés de la fonction getPodcastRssInfos()) au fichier index.js

index.js; generatePlaylistForAmplitude()
Créé les attribus grace aux variables
